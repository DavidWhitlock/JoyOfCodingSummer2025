...
public class AppointmentBookServletTest {
  ...
  void addOneWordToDictionary() throws ServletException, IOException {
    ...
    HttpServletRequest request = mock(HttpServletRequest.class);
    when(request.getParameter(AppointmentBookServlet.OWNER_PARAMETER)).thenReturn(word);
    when(request.getParameter(AppointmentBookServlet.DESCRIPTION_PARAMETER)).thenReturn(definition);
